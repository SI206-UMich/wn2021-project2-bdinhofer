...
def get_titles_from_search_results(filename):
    ...
    for i in range(len(authors)):
        tuple_list.append((book_titles[i], authors[i]))
    return tuple_list
...
def summarize_best_books(filepath):
    ...
    for tag in title_tags:
        title = tag.get('alt')
        titles.append(title)
    url_tags = soup.find_all('a', class_="category__copy")
...
class TestCases(unittest.TestCase):
    ...
    def test_summarize_best_books(self):
        ...
        best_summaries = summarize_best_books('/Users/daviddinhofer/Documents/umsi206/HW/wn2021-project2-bdinhofer/best_books_2020.htm')
        ...
        self.assertEqual(best_summaries[0], ('Fiction', "The Midnight Library", 'https://www.goodreads.com/choiceawards/best-fiction-books-2020'))
...
summarize_best_books('/Users/daviddinhofer/Documents/umsi206/HW/wn2021-project2-bdinhofer/best_books_2020.htm')
